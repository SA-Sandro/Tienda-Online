...
<nav id="navegador" class=" navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto text-center d-flex align-items-center">
            ...
            <li class="nav-item ">
                <a class="nav-link active" href="http://localhost/Tienda-online/Views/tienda">Tienda</a>
            </li>
            ...
            <li>
                <div class="divCarrito p-4 mx-4 rounded">
                    <a href="<?= URL ?>/Views/iniciarSesion" type="button" class="btn btn-primary position-relative p-2">
                    ...
                    ?>
                        <div class="producto d-flex flex-column justify-content-center mt-4 ">
                            ...
                            <div class="d-flex justify-content-center align-items-center p-4">
                                ...
                                <a href="<?= URL ?>/Views/iniciarSesion" type="button" class="addToCart text-center">Añadir al carrito <i class="bi bi-chevron-right"></i></a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
